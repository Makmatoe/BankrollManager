...
public sealed partial class MainForm
{
    ...
    private Control BuildCashInspector()
    {
        ...
        layout.Controls.Add(_cashInspectorTitle, 0, 0);
        layout.Controls.Add(_cashInspectorResult, 0, 1);
        layout.Controls.Add(_cashInspectorMeta, 0, 2);
        layout.Controls.Add(_cashInspectorNotes, 0, 3);
        UpdateCashInspector();
        return shell;
    }
