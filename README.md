...
```powershell
.\scripts\publish.ps1 -Version v0.4.0
```
...
- Daily, monthly, yearly, platform, format, and category reviews with separate cash P/L, ticket P/L, combined value P/L, and selected-day replay.
